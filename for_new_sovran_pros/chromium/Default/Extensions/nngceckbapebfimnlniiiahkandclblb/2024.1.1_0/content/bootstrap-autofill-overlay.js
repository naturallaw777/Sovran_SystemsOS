...
AutoFillConstants.PasswordFieldIgnoreList = [
    "onetimepassword",
    "captcha",
    "findanything",
    "forgot",
...
class AutofillOverlayContentService {
    constructor() {
        ...
        this.setupMutationObserver = () => {
            ...
            this.documentElementMutationObserver = new MutationObserver(this.handleDocumentElementMutationObserverUpdate);
         ...
         */
        this.handleDocumentElementMutationObserverUpdate = (mutationRecords) => {
            if ((!this.overlayButtonElement && !this.overlayListElement) ||
                this.isTriggeringExcessiveMutationObserverIterations()) {
                return;
            }
     ...
     */
    moveDocumentElementChildrenToBody(nodes) {
...
class CollectAutofillContentService {
    ...
    createAutofillFieldLabelTag(element) {
        ...
        if (!labelElementsSet.size &&
            ((_b = element.parentElement) === null || _b === void 0 ? void 0 : _b.tagName.toLowerCase()) === "dd" &&
            ((_c = element.parentElement.previousElementSibling) === null || _c === void 0 ? void 0 : _c.tagName.toLowerCase()) === "dt") {
