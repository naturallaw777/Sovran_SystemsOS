...
[Download the ISO](https://downloads.sovransystems.com/Sovran_SystemsOS-1.1.0.iso) ·
[Try it safely in a VM](#try-it-first-in-a-virtual-machine) ·
[Verify the Download](https://downloads.sovransystems.com/Sovran_SystemsOS-1.1.0.iso.sha256) ·
...
- [Download Sovran_SystemsOS-1.1.0.iso](https://downloads.sovransystems.com/Sovran_SystemsOS-1.1.0.iso)
- [Download Sovran_SystemsOS-1.1.0.iso.sha256](https://downloads.sovransystems.com/Sovran_SystemsOS-1.1.0.iso.sha256)
...
```bash
sha256sum --check Sovran_SystemsOS-1.1.0.iso.sha256
```

A successful comparison reports:

```text
Sovran_SystemsOS-1.1.0.iso: OK
```

You can also run `sha256sum Sovran_SystemsOS-1.1.0.iso` and compare the output
...
```bash
shasum -a 256 Sovran_SystemsOS-1.1.0.iso
```

Compare the value shown in Terminal with the value inside
`Sovran_SystemsOS-1.1.0.iso.sha256`.
...
```powershell
Get-FileHash .\Sovran_SystemsOS-1.1.0.iso -Algorithm SHA256
```
...
2. Choose **Flash from file** and select `Sovran_SystemsOS-1.1.0.iso`.
...
[Download Sovran_SystemsOS](https://downloads.sovransystems.com/Sovran_SystemsOS-1.1.0.iso) ·
