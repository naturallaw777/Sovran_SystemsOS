...
let
  ...
  #    The profile path is intentionally ephemeral (cleaned up on exit) but
  #    uses a fixed, user-scoped path so the app_id stays constant during
  #    the session.
